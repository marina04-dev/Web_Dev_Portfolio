...
const CarDetails = () => {
  ...
  const { id } = useParams();
  const { navigate, cars, axios, pickupDate, setPickupDate, returnDate, setReturnDate } = useAppContext();
    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        <motion.div initial={{opacity: 0, y: 30}} animate={{opacity: 1, y: 0}} transition={{duration: 0.6}} className='lg:col-span-2'>
          <motion.img initial={{opacity: 0, scale: 0.98}} animate={{opacity: 1, scale: 1}} transition={{duration: 0.5}} src={car.image} className='w-full h-auto md:max-h-100 object-cover rounded-xl mb-6 shadow-md'/>
