      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='flex flex-col w-full'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <input type='number' value={car.seating_capacity} placeholder='4' onChange={e => setCar({...car, seating_capacity: e.target.value})} required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'/>
          </div>
        </div>
        {/* Car Location */}
        <div className='flex flex-col w-full'>
