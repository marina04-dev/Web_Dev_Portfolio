...
const DoctorProfile = () => {
  ...
  const { backendUrl, dtoken, setProfileData, getProfileData, profileData } = useContext(DoctorContext);
    ...
    <div>
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          <p className='text-gray-600 font-medium mt-4'>Appointment's Fee: <span className='text-gray-800'>{currency} {isEdit ? <input type='number' onChange={(e) => setProfileData(prev => ({...prev, fees: e.target.value}))} value={profileData.fees}/> : profileData.fees}</span></p>
