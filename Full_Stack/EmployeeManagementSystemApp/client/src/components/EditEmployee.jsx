...
const EditEmployee = () => {
    ...
    useEffect(() => {
        ...
        .then(result => {
            setEmployee({...employee, name: result.data.Result[0].name,
                email: result.data.Result[0].email, password: result.data.Result[0].password,
                address: result.data.Result[0].address, salary: result.data.Result[0].salary,
        ...
        <form className="row g-1" onSubmit={handleSubmit}>
          <div className="col-12">
            ...
            <input type="text" className="form-control rounded-0"
              id="inputName" placeholder="Enter Name" value={employee.name} onChange={(e) => setEmployee({ ...employee, name: e.target.value })}/>
          </div>
          <div className="col-12">
