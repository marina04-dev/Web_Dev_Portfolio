...
const AllRooms = () => {
    ...
    // Functions to handle changes for filters and sorting
    ...
    // Function to sort rooms based on the selected sort option/s
    const sortRooms = (a,b) => {
    ...
    // Function to handle destination filter
    ...
    // Function to sort rooms based on the selected filters and sorting option/s
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16'>
            <div className={`flex items-center justify-between px-5 py-2.5 min-lg:border border-gray-300 ${openFilters && "border-b"}`}>
